...
// Admin oversight only, same convention as every other module this session.
    ...
    <div className="mx-auto max-w-[1280px]">
      ...
      <div className="mt-6 rounded-[16px] border border-border bg-surface p-[18px]">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <form action="/admin/health" className="flex items-center gap-2">
            <AutoSubmitSelect
              name="action"
      ...
      <div className="mt-6 grid grid-cols-1 gap-[18px] lg:grid-cols-2">
        <div className="rounded-[16px] border border-border bg-surface p-[18px]">
          ...
          <ul className="mt-3 flex flex-col divide-y divide-border">
            ...
            {alerts.map((a) => (
              <li key={a.id} className="card-hover flex flex-wrap items-center justify-between gap-2 py-2.5 text-[13px]">
                <div>
        ...
        <div className="rounded-[16px] border border-border bg-surface p-[18px]">
          ...
          <ul className="mt-3 flex flex-col divide-y divide-border">
            ...
            {escalations.map((e) => (
              <li key={e.id} className="card-hover flex flex-wrap items-center justify-between gap-2 py-2.5 text-[13px]">
                <div>
                  <p className="font-semibold text-text">
