// Principal -> Finance -> Overview: read-only mirror of Admin's own
// /admin/finance/overview page (Fee Overview + Fee Status). Student links
// point at Principal's OWN Students module (/vice-principal/students/[id], Phase
// 2), never Admin's -- Principal never reuses another role's route.
...
export default async function PrincipalFinanceOverviewPage({
  searchParams,
}: {
  ...
  function hrefWith(overrides: Record<string, string | undefined>) {
    ...
    return `/vice-principal/finance/overview?${next.toString()}`;
  }
  ...
  return (
    <div className="mx-auto max-w-[1280px]">
      ...
      <FinanceTabBar active="Overview" basePath="/vice-principal/finance" />
      ...
      <FeeStatusFilterBar
        ...
        grades={grades}
        sections={sections}
        formActionOverride="/vice-principal/finance/overview"
      />
            ...
            {demands.map((d) => (
              <tr key={d.id} className="card-hover">
                <td className="px-4 py-3 font-semibold text-text">
                  <Link href={`/vice-principal/students/${d.studentId}`} className="hover:underline">
