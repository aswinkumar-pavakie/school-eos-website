// Real E2EE messaging for Vice Principal (website) -- same shared
// MessagingApp every other newly-connected role uses
// (src/components/messaging-ui/MessagingApp.tsx). Vice Principal already
// has this working on mobile; this was the missing website side.
...
export default async function VicePrincipalMessagesPage() {
  try {
