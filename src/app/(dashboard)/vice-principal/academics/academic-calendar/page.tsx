...
export default async function PrincipalAcademicCalendarPage({
  ...
  const yearFilter = (
    <form action="/vice-principal/academics/academic-calendar" className="flex items-end gap-3">
  ...
  return (
    <div className="mx-auto max-w-[1100px]">
      <MonthCalendar
        ...
        subtitle="Term dates, holidays, exams, and school events — view-only. Adding or removing events is an Admin action."
