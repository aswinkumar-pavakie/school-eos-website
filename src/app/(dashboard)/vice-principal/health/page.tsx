...
// Vice Principal oversight only, same real endpoint and same convention as
// every other module this session (Admin's own page at admin/health is
// identical).
...
export default async function VicePrincipalHealthPage({
  searchParams,
}: {
    ...
    <div className="mx-auto max-w-[1280px]">
      ...
      <div className="mt-6 rounded-[16px] border border-border bg-surface p-[18px]">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <form action="/vice-principal/health" className="flex items-center gap-2">
            <AutoSubmitSelect
              name="action"
