// VicePrincipal -> Repair & Maintenance: read-only oversight of the same real
...
// with Admin; VicePrincipal gets the same overview KPIs, filters and request
// list, view-only.
...
export default async function VicePrincipalMaintenancePage({
  searchParams,
}: {
  ...
  function hrefWith(overrides: Record<string, string | undefined>) {
    ...
    return `/vice-principal/maintenance?${next.toString()}`;
  }
  ...
  return (
    <div className="mx-auto max-w-[1280px]">
      ...
      <MaintenanceFilterBar
        ...
        formActionOverride="/vice-principal/maintenance"
      />
            ...
            {requests.map((r) => (
              <tr key={r.id} className="card-hover">
                ...
                <td className="px-4 py-3 text-right">
                  <Link href={`/vice-principal/maintenance/${r.id}`} className="text-[13px] font-semibold text-primary">
                    View
                  </Link>
                </td>
              </tr>
