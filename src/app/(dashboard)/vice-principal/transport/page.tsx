// Vice Principal -> Transport: read-only oversight, identical in shape and
// data to Principal's own Transport page (see that file's own comment) --
// shares TransportOversightRoutesList/computeTransportKpis/
// TransportListKpiCard so both roles render byte-identical markup, only the
// route links point at this role's own /vice-principal/transport/* namespace.
...
export default async function VicePrincipalTransportPage() {
  ...
  return (
    <div className="mx-auto max-w-[1024px]">
      ...
      <TransportOversightRoutesList routes={routeRows} basePath="/vice-principal/transport" />
    </div>
  );
}
