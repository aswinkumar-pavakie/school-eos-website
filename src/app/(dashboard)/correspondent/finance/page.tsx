// Correspondent -> Finance: Fee Heads & Structures -- read-only mirror of
// Admin's own /admin/finance page (same real fee-heads/fee-structures data
// Principal's own /principal/finance page already shows -- see
// fee-heads.controller.ts/fee-structures.controller.ts, both already grant
// CORRESPONDENT). FinanceTabs has no create/edit controls at all (write
// operations live in Finance's own module) so it's reused verbatim,
// unmodified, exactly as Admin/Principal use it.

import { FinanceTabBar } from "@/components/finance/FinanceTabBar";
import { FinanceTabs } from "@/components/finance/FinanceTabs";
import { apiFetch } from "@/lib/api";

export default async function CorrespondentFinancePage({
  searchParams,
}: {
  ...
  return (
    <div className="mx-auto max-w-[1024px]">
      ...
      <FinanceTabBar active="Fee Heads & Structures" basePath="/correspondent/finance" />
      <div className="mt-6">
        <FinanceTabs
          feeHeads={feeHeads}
