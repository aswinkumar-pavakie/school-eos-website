...
// Principal's own inventory item detail page already uses.
...
export default async function PrincipalInventoryItemDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-[860px]">
      <BackLink href="/correspondent/inventory" label="Back to Inventory" />
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href={`/correspondent/audit?objectType=inventory_item&objectId=${item.id}&returnTo=${encodeURIComponent(`/correspondent/inventory/items/${item.id}`)}`}
