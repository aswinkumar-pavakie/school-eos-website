...
// real data (same GET /timetable?sectionId=, /grades, /sections) and design
// (grade/section picker -> TimetableGrid). This page has nothing to strip for
// Principal: even Admin's own copy is entirely view-only -- no create/edit/
// approve capability exists anywhere in this app for Class Timetable yet.
...
export default async function PrincipalClassTimetablePage({
  ...
  return (
    <div className="mx-auto max-w-[1100px]">
      <h1 className="text-[28px] font-bold leading-[34px] text-text">Class Timetable</h1>
      <p className="mt-1 text-sm text-text-muted">Real weekly schedule, by class and section.</p>

      <form action="/principal/academics/class-timetable" className="mt-6 flex flex-wrap items-end gap-3">
