...
export default async function PrincipalCommunityPage({
  ...
  function hrefWith(overrides: Record<string, string | undefined>) {
    ...
    return `/principal/community?${next.toString()}`;
  }
  ...
  return (
    <div className="mx-auto max-w-[1280px]">
      ...
      <form action="/principal/community" className="mt-6 flex flex-wrap items-end gap-3">
            ...
            {communities.map((c) => (
              <tr key={c.id}>
                ...
                <td className="px-4 py-3 text-right">
                  <Link href={`/principal/community/${c.id}`} className="text-[13px] font-semibold text-primary">
                    View
                  </Link>
                </td>
              </tr>
