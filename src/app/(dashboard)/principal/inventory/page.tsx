...
export default async function PrincipalInventoryPage({
  ...
  function hrefWith(overrides: Record<string, string | undefined>) {
    ...
    return `/principal/inventory?${next.toString()}`;
  }
  ...
  return (
    <div className="mx-auto max-w-[1280px]">
      ...
      <InventoryFilterBar
        ...
        formActionOverride="/principal/inventory"
      />
            ...
            {items.map((item) => (
              <tr key={item.id}>
                ...
                <td className="px-4 py-3 text-right">
                  <Link href={`/principal/inventory/items/${item.id}`} className="text-[13px] font-semibold text-primary">
                    View
                  </Link>
                </td>
              </tr>
