...
// Students module (/principal/students/[id]), never Admin's.
...
export default async function PrincipalFinancePaymentsPage({
  ...
  function hrefWith(overrides: Record<string, string | undefined>) {
    ...
    return `/principal/finance/payments?${next.toString()}`;
  }
  ...
  return (
    <div className="mx-auto max-w-[1280px]">
      ...
      <FinanceTabBar active="Payments" basePath="/principal/finance" />

      <PaymentsFilterBar
        search={params.search ?? ""}
        state={params.state ?? ""}
        mode={params.mode ?? ""}
        formActionOverride="/principal/finance/payments"
      />
