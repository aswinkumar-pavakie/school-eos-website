...
// point at Principal's OWN Students module (/principal/students/[id], Phase
...
export default async function PrincipalFinanceOverviewPage({
  ...
  function hrefWith(overrides: Record<string, string | undefined>) {
    ...
    return `/principal/finance/overview?${next.toString()}`;
  }
  ...
  return (
    <div className="mx-auto max-w-[1280px]">
      ...
      <FinanceTabBar active="Overview" basePath="/principal/finance" />
      ...
      <FeeStatusFilterBar
        ...
        grades={grades}
        sections={sections}
        formActionOverride="/principal/finance/overview"
      />
            ...
            {demands.map((d) => (
              <tr key={d.id}>
                <td className="px-4 py-3 font-semibold text-text">
                  <Link href={`/principal/students/${d.studentId}`} className="hover:underline">
