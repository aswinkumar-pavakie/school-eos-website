// Real E2EE messaging for Transport Manager -- same shared MessagingApp
// every other newly-connected role uses
// (src/components/messaging-ui/MessagingApp.tsx).
...
export default async function TransportManagerMessagesPage() {
  try {
