// Community -> Communities -> detail: read-only mirror of Admin's own
// community detail page (basic info, membership roster, activities,
// announcements) -- same three pure-display section components Principal's
// own detail page already reuses (no props/links baked in for any specific
// role, confirmed by inspection). No EditCommunityForm, no add-member/
// record-consent/remove, no create-activity, no create/publish/archive-
// announcement controls -- those stay Admin operational actions.
...
export default async function CommunityCommunityDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-[960px]">
      <BackLink href="/community/community" label="Communities" />
