...
// Catches any render-time failure across every /community/* page (a backend
...
// unreachable, an expired session with no refresh token throwing
// AuthExpiredError mid-render, etc.). Same shape as admin/error.tsx -- a
// generic, role-agnostic fallback, not new functionality.
