// Shared small form primitives for the Sports panels -- same local-component
// pattern CreateStudentModal.tsx / academics/shared.tsx established (duplicated
// per module rather than a cross-phase shared abstraction).
"use client";
