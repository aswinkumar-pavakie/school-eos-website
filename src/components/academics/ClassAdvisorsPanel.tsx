  ...
  return (
    <div>
      <PanelHeader
        ...
        subtitle={`One advisor per section for the current academic year. Assigning a new one automatically ends the previous assignment. · ${visibleSections.length} of ${sections.length} sections`}
      />
      <div className="mb-3 mt-4 flex flex-wrap items-center gap-4">
        ...
        <label className="flex items-center gap-2 text-sm">
          <span className="text-[11px] font-bold uppercase tracking-[0.09em] text-text-muted">Section</span>
          <select
            value={sectionFilter}
        ...
        <table className="w-full min-w-[560px] text-left text-sm">
          <thead>
            <tr className="border-b border-border text-[11px] font-bold uppercase leading-[14px] tracking-[0.09em] text-text-muted">
              ...
              <th className="py-2.5 pr-3">Assigned</th>
  ...
  return (
    <>
      <tr>
        ...
        <td className="py-3 pr-3 text-text-muted">{current?.validFrom ? formatDate(current.validFrom) : "—"}</td>
          ...
          <td colSpan={5} className="pb-3">
            ...
            >
              ...
              <div className="min-w-[240px]">
                <StaffPersonPicker disabled={isPending} name="personId" label="Class advisor" />
              </div>
