// Shared small form primitives for the Settings panels -- same local-component
// pattern CreateStudentModal.tsx / sports/shared.tsx established (duplicated per
// module rather than a cross-phase shared abstraction).
"use client";
