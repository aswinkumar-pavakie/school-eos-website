...
const STATUS_LABELS: Record<string, string> = {
  ...
  // a label for yet. (DAMAGED/LOST/RETIRED already covered by the Library
  // additions above, with identical labels -- not repeated here.)
  PRESENT: "Present",
  ABSENT: "Absent",
  LATE: "Late",
  HALF_DAY: "Half day",
...
const STATUS_TONE: Record<string, StatusTone> = {
  ...
  // Faculty module (DAMAGED/LOST/RETIRED already covered by Library above).
